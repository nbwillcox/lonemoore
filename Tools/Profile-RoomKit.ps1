...
if($buildRoot -ne $candidate){throw 'Room kit benchmark requires the isolated RoomKitCandidate package.'}
...
$out=Join-Path $projectRoot "Saved\RoomKitPass\Performance\$Label"
